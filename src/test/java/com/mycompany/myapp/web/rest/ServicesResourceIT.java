...
class ServicesResourceIT {
    ...
    public static Services createEntity(EntityManager em) {
        Services services = new Services().libelleService(DEFAULT_LIBELLE_SERVICE);
        return services;
    }
    ...
    public static Services createUpdatedEntity(EntityManager em) {
        Services services = new Services().libelleService(UPDATED_LIBELLE_SERVICE);
        return services;
    }
    ...
    void createServices() throws Exception {
        ...
        assertThat(testServices.getLibelleService()).isEqualTo(DEFAULT_LIBELLE_SERVICE);
    }
    ...
    void putNewServices() throws Exception {
        ...
        updatedServices.libelleService(UPDATED_LIBELLE_SERVICE);
        ...
        Services testServices = servicesList.get(servicesList.size() - 1);
        assertThat(testServices.getLibelleService()).isEqualTo(UPDATED_LIBELLE_SERVICE);
    }
    ...
    void fullUpdateServicesWithPatch() throws Exception {
        ...
        partialUpdatedServices.libelleService(UPDATED_LIBELLE_SERVICE);
